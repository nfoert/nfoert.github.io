...
{#if icon.startsWith("https://")}
    ...
    <div class={open ? "bg-slate-700/40 border-2 border-slate-600/50 transition-all rounded-xl p-4" : ""}>
        <button onclick={() => open = !open} class="gap-1 flex items-center md:items-left text-md px-6 py-2 rounded-full hover:bg-slate-600/40 active:bg-slate-700/60 transition-all hover:scale-105 active:scale-95 text-center md:text-left text-white">
